...
It is the status of the species at the most recent assessment year. For species which haven't been assessed since 2010, their status at 2010 is taken to be their current status. It follows that such species are counted as having their status unchanged from 2010 till now.
...
```{r present status is from before 2010}
print(
  paste(
