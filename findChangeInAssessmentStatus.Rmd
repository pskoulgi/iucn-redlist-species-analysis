...
Assessments happen for different species at different times, so there is no fixed schedule of Red List updation. Hence, for our purposes, we choose the 2010 status as the one prior, and closest, to it. We choose the most recent status as the present status
